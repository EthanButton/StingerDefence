...
st.markdown("*Defense Market & Company Overview – June 24, 2025
...
Lockheed Martin (LMT) successfully tested its Long Range Discrimination Radar (LRDR) in Alaska, tracking a target over 2,000 km—supporting its role in the 175 billion dollars “Golden Dome” missile defense project, expected to be operational by 2029. Lockheed also completed the TR-3 upgrade to its F-35 fleet, pending final U.S. approval, with current production at 20 jets per month and a target of up to 190 deliveries in 2025. However, it announced a 10% workforce reduction at its Greenville, SC plant after losing an F-16 maintenance contract.
Raytheon Technologies (RTX) secured several major contracts: a 250 million dollar deal with Mitsubishi Electric to produce the ESSM Block 2 missile in Japan; a 646 million dollars U.S. Navy contract for AN/SPY-6 radars; and a 1.1 billion dollar award to scale AIM-9X Block II missile production to 2,500 units annually.

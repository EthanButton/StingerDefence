...
st.text("""Today’s defense sector activity highlighted key contract wins, stable trading, and continued momentum in radar, missile, and aircraft programs among leading U.S. firms.
